<?php 
	...
	if (isset($_POST['signup'])) {
		...
		if ($chk_error == false) {
    		...
    		// 	} else {
				$SQL = "INSERT INTO users(Name,Email,password,Abbrev) VALUES('" . $user_name . "','" . $user_email . "','" . md5($user_passwd) . "','" . ($user_branch) . "')";
...
<?php
	if ($chk_error) { ?>
		<div class="alert alert-danger alert-dismissible fade show" role="alert">
					...
					<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close" onclick="document.location = 'signup_user.php'" style = "justify-content: right;"></button>
			  </div>
	<?php } else { 
		            ...
		            <div class="col-xl-4 col-lg-4 col-md-4 col-md-offset-4 well" id="sign"><br>
			            <form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="signupform"> <!--action = "register.php"!-->
				            <fieldset>
								...
								<div class="form-group">
						            <label for="dropbranch" style="font-weight: bold;">Choose a field of study</label>
